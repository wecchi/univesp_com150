...
##Exemplo 25
#     C(1) = 1
#     C(n) = 1 + C(n/2) para n > 1
def exemplo25(n):
    if n == 1:
        return n
    else:
        return 1 + exemplo25(n/2)


print('\n', str('>>> Início do programa Exemplo 25 <<<').center(80, '-'), sep='')
for i in [2, 4, 8, 16, 32]:
    print('exemplo25({0}) = {1}'.format(i, exemplo25(i)))
print(str('>>> Fim do programa Exemplo 25 <<<').center(80, '-'))


##Exemplo 26
#     T(1) = 3
#     T(n) = 2*T(n/2) + 2n para n > 1
def exemplo26(n):
    if n == 1:
        return 3
    else:
        return 2 * exemplo26(n/2) + 2 * n


print('\n', str('>>> Início do programa Exemplo 26 <<<').center(80, '-'), sep='')
for i in [2, 4, 8, 16, 32]:
    print('exemplo26({0}) = {1}'.format(i, exemplo26(i)))
print(str('>>> Fim do programa Exemplo 26 <<<').center(80, '-'))


##Problema Prático 15
#     S(1) = 1
#     S(n) = 2*S(n/2) + 1 para n > 1
def problema15(n):
    if n == 1:
        return n
    else:
        return 2 * problema15(n/2) + 1


print('\n', str('>>> Início do programa Problema Prático 15 <<<').center(80, '-'), sep='')
for i in [2, 4, 8, 16, 32]:
    print('problema15({0}) = {1}'.format(i, problema15(i)))
print(str('>>> Fim do programa Problema Prático 15 <<<').center(80, '-'))